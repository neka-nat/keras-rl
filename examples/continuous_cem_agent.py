...
class ContinuousCEMAgent(Agent):
    """Write me
    """
    def __init__(self, model, nb_actions, memory, batch_size=50, nb_steps_warmup=1000,
                 ...
                 noise_decay_const=0.0, noise_ampl=0.0, random_process=None, **kwargs):
        super(ContinuousCEMAgent, self).__init__(**kwargs)
    ...
    def select_action(self, state, stochastic=False):
        ...
        if (stochastic or self.training) and self.random_process is not None:
